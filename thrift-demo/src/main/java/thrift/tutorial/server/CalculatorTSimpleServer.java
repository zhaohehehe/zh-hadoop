 ...
 *
 */
public class CalculatorTSimpleServer {

	public static void main(String[] args) {
		try {
			CalculatorServiceImpl handler = new CalculatorServiceImpl();
			@SuppressWarnings({ "unchecked", "rawtypes" })
			TCalculatorService.Processor processor = new TCalculatorService.Processor(handler);
	...
	public static void simple(@SuppressWarnings("rawtypes") TCalculatorService.Processor processor) {
		try {
	...
	public static void secure(@SuppressWarnings("rawtypes") TCalculatorService.Processor processor) {
		try {
			/*
